...
**audits** | [**\Swagger\Client\Model\ConnectDecisionEngineRunDecisionResponseAudits[]**](ConnectDecisionEngineRunDecisionResponseAudits.md) | An array of audit values. The paramters output for audit are tailored and bespoke to each decision tree. | [optional] 
