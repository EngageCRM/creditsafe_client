...
/**
 * ConnectMonitoringCreatePortfolioResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConnectMonitoringCreatePortfolioResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Connect.Monitoring.CreatePortfolioResponse';
...
'is_default' => 'getIsDefault'    ];
     ...
     * Sets name
     *
     * @param string $name The name that was assigned to this portfolio
     *
     * @return $this
     */
     ...
     * Sets is_default
     *
     * @param bool $is_default Shows if the portfolio is set as Default for the user.
     *
     * @return $this
     */
