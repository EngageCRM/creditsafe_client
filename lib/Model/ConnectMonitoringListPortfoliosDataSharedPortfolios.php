...
/**
 * ConnectMonitoringListPortfoliosDataSharedPortfolios Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConnectMonitoringListPortfoliosDataSharedPortfolios implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Connect.Monitoring.ListPortfolios_data_sharedPortfolios';
...
'name' => 'getName'    ];
     ...
     * Sets name
     *
     * @param string $name A name of the portfolio
     *
     * @return $this
     */
