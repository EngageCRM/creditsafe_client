...
/**
 * ConnectMonitoringUpdateEventRulesBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConnectMonitoringUpdateEventRulesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Connect.Monitoring.UpdateEventRulesBody';
...
'param2' => 'getParam2'    ];
     ...
     * Sets rule_code
     *
     * @param int $rule_code The unique ID of the EventRule
     *
     * @return $this
     */
     ...
     * Sets is_active
     *
     * @param int $is_active Flag to show if EventRule is active or not. 0 for false, 1 for true.
     *
     * @return $this
     */
